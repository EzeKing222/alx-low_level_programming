 ...
 * @e_iden: A pointer to an array containing the ELF magic
 * numbers.
...
/**
 * print_osabi - Prints the ABI version of an ELF header.
 * @e_iden: A pointer to an array containing the ELF magic
 * numbers.
 * Return: void.
 */
 ...
 * @e_entry: The ELF address of the ELF entry point.
 * @e_ident: A pointer to an array of ELF class.
 * Return: void.
*/
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
 ...
 * @elf: The ELF file descriptor of the ELF file.
 * Return: void.
*/
void close_elf(int elf)
{
